 ...
 * </p>
 * <p>
 * This enum may be prone to further additions, such as the {@link #LONG_ARRAY} which has been added
 * by Mojang in NBT Version 19133. (second NBT version)
 * </p>
 * <p>
...
public enum NBTType {
   ...
   * </p>
   * <p>
   * Although this method is currently equivalent to {@link #ordinal()}, it should always be used in
   * its stead, since it is not guaranteed that this behavior will remain consistent.
   * </p>
   *
   * @return the id
   */
   ...
   * </p>
   * <p>
   * All tag types with payloads that are representable as a {@link Number} are compliant with this
   * definition.
   * </p>
   *
  ...
  /**
   * Returns whether this tag type is is an array type such as {@link NBTByteArray} or {@link
   * NBTIntArray}.
   *
